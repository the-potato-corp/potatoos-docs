...
* **The Smash Shell:** The command-line environment is designed for **familiarity and extension**. It will adopt a largely Bash-compatible syntax to ease migration for power users, while also offering direct execution of STARCH scripts for advanced system configuration and scripting.
